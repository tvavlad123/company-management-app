...
public class CompManagementRoleEpo implements Serializable {
   ...
   private CompManagementRoleEpo() {}
   
   public CompManagementRoleEpo(long id, String name) {
      this.id = id;
      this.name = name;
   ...
   public boolean equals(Object o) {
      ...
      CompManagementRoleEpo roleEpo = (CompManagementRoleEpo)o;
